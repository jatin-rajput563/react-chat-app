                        ...
                        <div className="col-12 col-lg-6">
                            <div className='pl-100 pt-42'>
                                ...
                                <div className='d-flex flex-wrap gap-25 mt-40 justify-content-center align-items-baseline'>
                                    ...
                                    <p className='solution-star-para fw-normal opacity-75 max-w-274'><span className='fw-bold'>5,200 businesses </span> use ChatApp and they rate it as <span className='fw-bold'>5-stars.</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
